...
public class SimulatedAnnealing extends Generator {
  ...
  /**
   * Iteration index (global) at which the next temperature update
   * must be performed.
   */
  public static int countIterationsT;

  /**
   * Stores the repetition period of the temperature (how many iterations
   * before decreasing temperature again).
   */
